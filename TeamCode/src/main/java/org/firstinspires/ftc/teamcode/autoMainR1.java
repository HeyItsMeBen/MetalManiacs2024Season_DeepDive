...
public class autoMainR1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (testMode==2) {
            ...
            telemetry.update();
            claw.open_close(0.5615, 0.8135); //closes(grabs) //to open left one: increase //to open Right one: decrease
            sleep(1000);
            claw.moveArm(0.25);
            sleep(5000);
            ...
            telemetry.addLine("Moving to basket...");
            telemetry.update();
            drive1.moveLeft(10.5* 1.33333, dblPower); //tileLength * 0.33333 * 1.33333 --> 11.5* 1.33333 --> 10.5* 1.33333
            //sleep(1000);
            ...
            claw.moveArm(-0.25);
            sleep(5000);
            drive1.moveForward(tileLength * 0.5 -2, dblPower); //-6-->-1-->+2.5-->-1
            //sleep(1000);
