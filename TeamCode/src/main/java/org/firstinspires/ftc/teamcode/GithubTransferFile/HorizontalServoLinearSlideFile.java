...
public class  HorizontalServoLinearSlideFile extends LinearOpMode
{
    ...
    private Servo HorizontalServoLinearSlideLeft = null;
    private Servo HorizontalServoLinearSlideRight = null;
    ...
    public void runOpMode()
    {
        ...
        HorizontalServoLinearSlideLeft = hardwareMap.get(Servo.class, "LinearSlideServoLeft"); //added 7/24/24
        HorizontalServoLinearSlideRight = hardwareMap.get(Servo.class, "LinearSlideServoRight");

        telemetry.addData(">", "Press Start");
        telemetry.addData(">","Both horizaontal slides will be extended sideways, then retracted after 3 seconds");
        telemetry.update();
        ...
        while (opModeIsActive())
        {
            ...
            HorizontalServoLinearSlideLeft.setPosition(1);
            HorizontalServoLinearSlideRight.setPosition(1);
            sleep(3000);
            HorizontalServoLinearSlideLeft.setPosition(-1);
            HorizontalServoLinearSlideRight.setPosition(-1);
