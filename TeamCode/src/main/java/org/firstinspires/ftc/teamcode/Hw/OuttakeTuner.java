...
public class OuttakeTuner extends OpMode {
    ...
    public static double outtakeArmTarget = 0;
    public static double outtakeClawTarget=0;
    ...
    public void loop() {
        slidesMove();
        outtakeArmServos.setArmTarget(outtakeArmTarget);
        outtakeClawServo.setPosition(outtakeClawTarget);
        ...
        telemetry.addData("outtakeArmPos", outtakeArmServos.getArmPosition());
